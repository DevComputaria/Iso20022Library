...
{
    /// <summary>
    /// Unit tests for Pain00700107Builder - Customer Payment Reversal V07.
    /// </summary>
    [TestClass]
    public class Pain00700107BuilderTests
    {
        private Pain00700107Builder _builder = null!;

        [TestInitialize]
        public void Setup()
        {
            _builder = new Pain00700107Builder();
        }
        ...
        public void MessageType_ShouldReturnCorrectType()
        {
            ...
            // Assert
            Assert.AreEqual(MessageType.Pain00700107, messageType);
        }
        ...
        public void SetGroupHeader_WithAllFields_ShouldSetAllFields()
        {
            ...
            var initiatingParty = Pain00700107Builder.CreatePartyIdentification("Test Bank");
        ...
        public void SetOriginalGroupInformation_WithAllFields_ShouldSetAllFields()
        {
            ...
            {
                Pain00700107Builder.CreatePaymentReversalReason(
                    Pain00700107Builder.CreatePartyIdentification("Test Originator"),
                    Pain00700107Builder.CreateReversalReasonWithCode("DUPL"),
        ...
        public void AddOriginalPaymentInstruction_WithAllFields_ShouldSetAllFields()
        {
            ...
            {
                Pain00700107Builder.CreatePaymentReversalReason(
                    Pain00700107Builder.CreatePartyIdentification("Test Bank"),
                    Pain00700107Builder.CreateReversalReasonWithCode("CUST"),
        ...
        public void AddPaymentTransactionReversal_WithValidTransaction_ShouldAddTransaction()
        {
            ...
            var transaction = Pain00700107Builder.CreatePaymentTransactionReversal(
                "TXN001",
                "INSTR123",
                "E2E123");
        ...
        public void CreatePaymentTransactionReversal_WithAllFields_ShouldSetAllFields()
        {
            ...
            var originalInstructionId = "INSTR123";
            var originalEndToEndId = "E2E123";
            var originalAmount = Pain00700107Builder.CreateCurrencyAndAmount(500.00m, "EUR");
            var reversedAmount = Pain00700107Builder.CreateCurrencyAndAmount(250.00m, "EUR");
        ...
        {
            // Act
            Pain00700107Builder.CreatePaymentTransactionReversal("TXN001", null!, "E2E123");
        }
        ...
        {
            // Act
            Pain00700107Builder.CreatePaymentTransactionReversal("TXN001", "INSTR123", null!);
        }
        ...
        {
            // Arrange
            var originator = Pain00700107Builder.CreatePartyIdentification("Test Originator");
            var reason = Pain00700107Builder.CreateReversalReasonWithCode("DUPL");
            var additionalInfo = new[] { "Duplicate payment detected", "Transaction ID: TXN123" };

            // Act
            var reversalReason = Pain00700107Builder.CreatePaymentReversalReason(
                originator,
                reason,
                additionalInfo);
        ...
        public void CreateReversalReasonWithCode_WithValidCode_ShouldCreateReason()
        {
            ...
            // Act
            var reason = Pain00700107Builder.CreateReversalReasonWithCode(reasonCode);
        ...
        {
            // Act
            Pain00700107Builder.CreateReversalReasonWithCode(null!);
        }
        ...
        public void CreateReversalReasonWithProprietary_WithValidReason_ShouldCreateReason()
        {
            ...
            // Act
            var reason = Pain00700107Builder.CreateReversalReasonWithProprietary(proprietaryReason);
        ...
        {
            // Act
            Pain00700107Builder.CreateReversalReasonWithProprietary(null!);
        }
        ...
        public void CreateCurrencyAndAmount_WithValidValues_ShouldCreateAmount()
        {
            ...
            // Act
            var currencyAmount = Pain00700107Builder.CreateCurrencyAndAmount(amount, currency);
        ...
        {
            // Act
            Pain00700107Builder.CreateCurrencyAndAmount(100.00m, null!);
        }
        ...
        {
            // Act
            Pain00700107Builder.CreateCurrencyAndAmount(-100.00m, "USD");
        }
        ...
        public void CreatePartyIdentification_WithName_ShouldCreateParty()
        {
            ...
            // Act
            var party = Pain00700107Builder.CreatePartyIdentification(name);
        ...
        public void BuildXml_WithDocumentParameter_ShouldReturnXml()
        {
            ...
            {
                CstmrPmtRvsl = new CustomerPaymentReversalV07
                {
        ...
        public void CompleteWorkflow_ShouldCreateValidMessage()
        {
            ...
            var initiatingParty = Pain00700107Builder.CreatePartyIdentification("ABC Bank Ltd");
            ...
            var reversalReason = Pain00700107Builder.CreatePaymentReversalReason(
                Pain00700107Builder.CreatePartyIdentification("Customer Service"),
                Pain00700107Builder.CreateReversalReasonWithCode("CUST"),
            ...
            var transaction1 = Pain00700107Builder.CreatePaymentTransactionReversal(
                "TXN001",
                "INSTR20241226001",
                "E2E20241226001",
                Pain00700107Builder.CreateCurrencyAndAmount(750.25m, "EUR"),
                Pain00700107Builder.CreateCurrencyAndAmount(750.25m, "EUR"),
                ChargeBearerType1Code.Slev,
                new[] { reversalReason });

            var transaction2 = Pain00700107Builder.CreatePaymentTransactionReversal(
                "TXN002",
                "INSTR20241226002",
                "E2E20241226002",
                Pain00700107Builder.CreateCurrencyAndAmount(750.50m, "EUR"),
                Pain00700107Builder.CreateCurrencyAndAmount(750.50m, "EUR"));
