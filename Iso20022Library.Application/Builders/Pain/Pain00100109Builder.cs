...
{
    /// <summary>
    /// Builder for constructing and serializing ISO 20022 pain.001.001.09 messages (Customer Credit Transfer Initiation V09).
    /// </summary>
    /// <remarks>
    /// The pain.001.001.09 message is used to initiate credit transfer instructions from a debtor to a creditor.
    ...
    /// </remarks>
    public class Pain00100109Builder : IMessageBuilder
    {
        private readonly Document _document;

        /// <summary>
        /// Initializes a new instance of the Pain00100109Builder class.
        /// </summary>
        public Pain00100109Builder()
        {
        ...
        /// </summary>
        public MessageType MessageType => MessageType.Pain00100109;
        ...
        public Pain00100109Builder SetGroupHeader(
            string messageId,
            ...
            PartyIdentification135? initiatingParty = null)
        {
            ...
            var groupHeader = new GroupHeader85
            {
                MsgId = messageId,
            ...
            _document.CstmrCdtTrfInitn = new CustomerCreditTransferInitiationV09
            {
                GrpHdr = groupHeader
            };
        ...
        public Pain00100109Builder AddPaymentInstruction(
            ...
            BranchAndFinancialInstitutionIdentification6 debtorAgent)
        {
            ...
            var paymentInstruction = new PaymentInstruction30
            {
        ...
        public Pain00100109Builder AddCreditTransferTransaction(CreditTransferTransaction34 creditTransfer)
        {
        ...
        /// <exception cref="InvalidOperationException">Thrown when no payment instruction exists.</exception>
        /// <exception cref="ArgumentNullException">Thrown when required parameters are null.</exception>
        public Pain00100109Builder AddCreditTransferTransaction(
            string endToEndId,
        ...
        public Pain00100109Builder SetCreditorAgent(BranchAndFinancialInstitutionIdentification6 creditorAgent)
        {
        ...
        public Pain00100109Builder SetCreditorAgentAccount(CashAccount38 creditorAgentAccount)
        {
        ...
        public Pain00100109Builder SetUltimateCreditor(PartyIdentification135 ultimateCreditor)
        {
        ...
        public Pain00100109Builder SetUltimateDebtor(PartyIdentification135 ultimateDebtor)
        {
        ...
        public Pain00100109Builder AddInstructionForCreditorAgent(InstructionForCreditorAgent1 instruction)
        {
        ...
        public Pain00100109Builder SetPaymentTypeInformation(PaymentTypeInformation26 paymentTypeInformation)
        {
        ...
        public Pain00100109Builder SetRemittanceInformation(RemittanceInformation16 remittanceInformation)
        {
        ...
        public Pain00100109Builder SetIntermediaryAgent1(BranchAndFinancialInstitutionIdentification6 intermediaryAgent)
        {
        ...
        public Pain00100109Builder SetIntermediaryAgent1Account(CashAccount38 intermediaryAgentAccount)
        {
        ...
        /// <exception cref="InvalidOperationException">Thrown when no credit transfer transaction exists.</exception>
        /// <exception cref="ArgumentNullException">Thrown when intermediaryAgent is null.</exception>
        public Pain00100109Builder SetIntermediaryAgent2(BranchAndFinancialInstitutionIdentification6 intermediaryAgent)
        {
            ValidateParameter(intermediaryAgent, nameof(intermediaryAgent));
        ...
        /// <exception cref="InvalidOperationException">Thrown when no credit transfer transaction exists.</exception>
        /// <exception cref="ArgumentNullException">Thrown when intermediaryAgentAccount is null.</exception>
        public Pain00100109Builder SetIntermediaryAgent2Account(CashAccount38 intermediaryAgentAccount)
        {
            ValidateParameter(intermediaryAgentAccount, nameof(intermediaryAgentAccount));
        ...
        /// <exception cref="InvalidOperationException">Thrown when no credit transfer transaction exists.</exception>
        /// <exception cref="ArgumentNullException">Thrown when intermediaryAgent is null.</exception>
        public Pain00100109Builder SetIntermediaryAgent3(BranchAndFinancialInstitutionIdentification6 intermediaryAgent)
        {
            ValidateParameter(intermediaryAgent, nameof(intermediaryAgent));
        ...
        /// <exception cref="InvalidOperationException">Thrown when no credit transfer transaction exists.</exception>
        /// <exception cref="ArgumentNullException">Thrown when intermediaryAgentAccount is null.</exception>
        public Pain00100109Builder SetIntermediaryAgent3Account(CashAccount38 intermediaryAgentAccount)
        {
            ValidateParameter(intermediaryAgentAccount, nameof(intermediaryAgentAccount));
        ...
        /// <summary>
        /// Builds the complete Pain.001.001.09 document.
        /// </summary>
        ...
        /// </summary>
        /// <returns>XML representation of the pain.001.001.09 message.</returns>
        /// <exception cref="InvalidOperationException">Thrown when the document is incomplete.</exception>
        ...
        private CreditTransferTransaction34 GetLastCreditTransferTransaction()
        {
            if (_document.CstmrCdtTrfInitn?.PmtInf == null || !_document.CstmrCdtTrfInitn.PmtInf.Any())
