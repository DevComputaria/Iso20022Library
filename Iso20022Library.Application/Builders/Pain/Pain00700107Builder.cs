...
{
    /// <summary>
    /// Builder for constructing and serializing ISO 20022 pain.007.001.07 messages (Customer Payment Reversal V07).
    /// Provides a fluent API for building payment reversal messages with comprehensive validation and XML serialization.
    /// </summary>
    /// <remarks>
    /// The pain.007.001.07 message is used to reverse a previously sent payment instruction.
    ...
    /// </remarks>
    public class Pain00700107Builder : IMessageBuilder
    {
        ...
        /// </summary>
        public MessageType MessageType => MessageType.Pain00700107;

        /// <summary>
        /// Initializes a new instance of the Pain00700107Builder class.
        /// </summary>
        public Pain00700107Builder()
        {
        ...
        public Pain00700107Builder SetGroupHeader(
            string messageId,
        ...
        public Pain00700107Builder SetOriginalGroupInformation(
        ...
        public Pain00700107Builder AddOriginalPaymentInstruction(
            ...
            IEnumerable<PaymentReversalReason7>? reversalReasonInformation = null)
        {
            ...
            var originalPaymentInstruction = new OriginalPaymentInstruction21
            {
        ...
        public Pain00700107Builder AddPaymentTransactionReversal(PaymentTransaction77 reversalTransaction)
        {
        ...
        /// <returns>A configured PaymentTransaction77 instance.</returns>
        /// <exception cref="ArgumentNullException">Thrown when originalInstructionId or originalEndToEndId is null.</exception>
        public static PaymentTransaction77 CreatePaymentTransactionReversal(
            string? reversalId,
            ...
            IEnumerable<PaymentReversalReason7>? reversalReasonInformation = null,
            OriginalTransactionReference24? originalTransactionReference = null)
        {
            ...
            var transaction = new PaymentTransaction77
            {
        ...
        public Pain00700107Builder AddSupplementaryData(SupplementaryData1 supplementaryData)
        {
