...
{
    /// <summary>
    /// Builder for constructing and serializing ISO 20022 pain.007.001.06 messages (Customer Payment Reversal V06).
    /// Provides a fluent API for building payment reversal messages with comprehensive validation and XML serialization.
    /// </summary>
    /// <remarks>
    /// The pain.007.001.06 message is used to reverse a previously sent payment instruction.
    ...
    /// </remarks>
    public class Pain00700106Builder : IMessageBuilder
    {
        ...
        /// </summary>
        public MessageType MessageType => MessageType.Pain00700106;

        /// <summary>
        /// Initializes a new instance of the Pain00700106Builder class.
        /// </summary>
        public Pain00700106Builder()
        {
        ...
        public Pain00700106Builder SetGroupHeader(
            string messageId,
        ...
        public Pain00700106Builder SetOriginalGroupInformation(
        ...
        public Pain00700106Builder AddOriginalPaymentInstruction(
            ...
            IEnumerable<PaymentReversalReason7>? reversalReasonInformation = null)
        {
            ...
            var originalPaymentInstruction = new OriginalPaymentInstruction16
            {
        ...
        public Pain00700106Builder AddPaymentTransactionReversal(PaymentTransaction64 reversalTransaction)
        {
        ...
        /// <returns>A configured PaymentTransaction64 instance.</returns>
        /// <exception cref="ArgumentNullException">Thrown when originalInstructionId or originalEndToEndId is null.</exception>
        public static PaymentTransaction64 CreatePaymentTransactionReversal(
            string? reversalId,
            ...
            IEnumerable<PaymentReversalReason7>? reversalReasonInformation = null,
            OriginalTransactionReference22? originalTransactionReference = null)
        {
            ...
            var transaction = new PaymentTransaction64
            {
        ...
        public Pain00700106Builder AddSupplementaryData(SupplementaryData1 supplementaryData)
        {
